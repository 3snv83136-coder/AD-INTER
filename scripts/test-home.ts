...
async function main() {
  ...
  console.log('Opening /...')
  await page.goto('https://app-allo-debouchage.vercel.app/', { waitUntil: 'networkidle', timeout: 30000 })
  ...
  const brandText = await page.locator('h1:has-text("Allo Débouchage")').isVisible().catch(() => false)

  console.log('Allo Débouchage h1 visible:', alloText)
