...
export function mergeFacturePayloadMeta(
  ...
  const { _allo_meta, ...rest } = facture
  return {
    ...rest,
    _allo_meta: { ...(typeof _allo_meta === "object" && _allo_meta ? _allo_meta : {}), ...meta },
  }
}

export function relanceIdsFromPayload(payload: unknown): string[] {
  if (!payload || typeof payload !== "object") return []
  const meta = (payload as { _allo_meta?: { relance_ids?: string[] } })._allo_meta
...
<p style="margin-top:24px;font-size:13px;color:#666">Cordialement,<br><strong>${tn}</strong><br>Allo Débouchage</p>
</td></tr>
<tr><td style="background:#0e2a52;color:#a0c0ff;padding:16px;text-align:center;font-size:11px">
Allo Débouchage · ${escapeHtml(input.tel)}
</td></tr>
</table>
</td></tr>
</table>
