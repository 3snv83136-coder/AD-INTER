...
4. ALLO_PUBLISH_TOKEN from Django backend
...
Replace `[PROJECT_NAME]` with your actual Vercel project name (e.g., app-allo-debouchage).
...
npx vercel env add ALLO_API_URL production
# Paste: https://allodebouchage.com

npx vercel env add ALLO_PUBLISH_TOKEN production
...
1. Open the Vercel URL (e.g., https://app-allo-debouchage.vercel.app)
...
### Allo Débouchage API not responding
- Verify ALLO_PUBLISH_TOKEN matches Django settings
- Check ALLO_API_URL is accessible from Vercel region
