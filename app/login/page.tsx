    ...
    >
        ...
        {BUBBLES.map((b, i) => (
          <span
            ...
            style={{
              ...
              animation: `alloBubble ${b.dur} linear ${b.delay} infinite`,
            }}
          />
        ))}
      </div>
      ...
      >
        <div
          ...
          style={{
            ...
            animation: 'alloSheen 9s ease-in-out infinite',
          }}
        />
      </div>
      ...
      >
        <div className="mb-7 flex flex-col items-center text-center">
          <div className="text-5xl" style={{ animation: 'alloDrop 3s ease-in-out infinite' }}>
            💧
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            ...
            style={{ animation: loading ? undefined : 'alloGlow 3s ease-in-out infinite' }}
          >
