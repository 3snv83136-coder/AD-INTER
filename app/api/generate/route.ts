...
export async function POST(req: NextRequest) {
  ...
  const reference = `Allo Débouchage-${today.getFullYear()}${String(today.getMonth() + 1).padStart(2, '0')}${String(today.getDate()).padStart(2, '0')}-${seq}`
    ...
    "@graph": [
      {
        ...
        "aggregateRating": {
          ...
          "ratingValue": process.env.BRAND_RATING_VALUE || "4.9",
          "reviewCount": process.env.BRAND_REVIEW_COUNT || "127",
          "bestRating": "5",
          "worstRating": "1"
        },
      ...
      },
      {
        ...
        "author": { "@type": "Organization", "name": "Allo Débouchage" },
