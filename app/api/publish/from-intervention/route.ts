 ...
 * seo_json et photos_urls) vers le site Django Allo Débouchage.
 *
...
export async function POST(req: NextRequest) {
  ...
  // Technicien : Django Allo Débouchage exige le champ technicien_name NOT NULL en base
  ...
  let djResp: Response
  try {
    djResp = await fetch(`${publishApiUrl}/api/gallery/publish/`, {
      method: 'POST',
