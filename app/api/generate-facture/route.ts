...
export async function POST(req: NextRequest) {
  ...
  const prompt = `Tu es un assistant spécialisé dans la rédaction de factures pour Allo Débouchage (Allo Débouchage, Var). Le technicien décrit dans une dictée vocale une intervention déjà réalisée. Tu dois en extraire les éléments structurés d'une facture.
