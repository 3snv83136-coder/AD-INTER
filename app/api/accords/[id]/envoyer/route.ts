...
export async function POST(req: NextRequest, { params }: Params) {
  ...
  const subject = `Votre accord d'intervention${accord.reference ? ` ${accord.reference}` : ''} — Allo Débouchage`
  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,.08)">
      ...
      <tr><td style="padding:30px">
        ...
        <p style="margin-top:30px;font-size:13px;color:#666">Cordialement,<br>Allo Débouchage</p>
      </td></tr>
      <tr><td style="background:#0e2a52;color:#a0c0ff;padding:18px;text-align:center;font-size:11px">
        Allo Débouchage · ${telEsc} · allodebouchage.com
      </td></tr>
    </table>
  </td></tr>
</table>
