...
<p>Bonjour,</p>
<p>Nous sommes le <strong>5 du mois</strong> et le relevé bancaire de <strong>${pl}</strong> n'a pas encore été déposé dans l'application Allo Débouchage.</p>
...
<p style="font-size:12px;color:#64748b;margin-top:20px">Allo Débouchage · ${escapeHtml(input.tel)}</p>
</div>
</body></html>`
}
