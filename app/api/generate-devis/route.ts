...
export async function POST(req: NextRequest) {
  ...
  const prompt = `Tu es un assistant spécialisé dans la rédaction de devis estimatifs pour une entreprise de débouchage et assainissement (Allo Débouchage, Var). À partir d'une dictée vocale du technicien/chef d'équipe, tu structures un devis complet.
...
- "conditions" : remplis avec les valeurs standards Allo Débouchage SI la dictée ne contradict pas :
  ...
  • assurance : "RC Pro et décennale Allo Débouchage en cours de validité"
