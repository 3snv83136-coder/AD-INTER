...
<p style="margin-top:18px">Cordialement,<br><strong>${tn}</strong><br>Allo Débouchage</p>
</td></tr>
...
<p style="font-size:13px;color:#64748b">Merci,<br><strong>${tn}</strong> — Allo Débouchage</p>
</div></body></html>`
}
