  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', color: '#e2e8f0', fontFamily: 'system-ui', padding: 40 }}>
      <div style={{ maxWidth: 800, margin: '0 auto' }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8, color: '#f1f5f9' }}>Preview PDF — Allo Débouchage</h1>
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 40 }}>
          <PDFDownloadButton {...sampleData} filename="preview-allo-rapport.pdf" />
          <button
