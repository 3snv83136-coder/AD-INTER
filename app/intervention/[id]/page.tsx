...
export default function InterventionDetailPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const key = `allo_devis_redirect_${intervention.id}`
  ...
  function goToRapport() {
    ...
    if (typeof window !== 'undefined') {
      if (hasRapport) {
        ...
        sessionStorage.setItem('allo_load_rapport_id', intervention.id)
        ...
        sessionStorage.setItem('allo_intervention_prefill', JSON.stringify(prefill))
