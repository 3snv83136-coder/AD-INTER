-- Migration initiale Allo Débouchage (consolidée depuis supabase/)
-- =====================================================================
-- Allo Débouchage CRM — Schéma Supabase Phase 1
...
create table if not exists interventions (
  id uuid primary key default gen_random_uuid(),
  reference text unique,                     -- Allo Débouchage-YYYYMMDD-HHMM
...
-- >>> supabase/migrations/001_compta_pro.sql
-- =====================================================================
-- Allo Débouchage Compta Pro — Migration 001
...
-- >>> supabase/migrations/002_video_generation.sql
-- =====================================================================
-- Allo Débouchage Vidéo génération — Migration 002
...
-- =====================================================================
-- 2. STORAGE — désormais Vercel Blob (voir lib/storage.ts)
-- =====================================================================
-- (bucket intervention-videos : migré vers Vercel Blob)
...
-- >>> supabase/migrations/003_mode_terrain.sql
-- =====================================================================
-- Allo Débouchage Mode Terrain — Migration 003
...
-- >>> supabase/migrations/004_intervention_pdfs.sql
-- =====================================================================
...
-- (bucket intervention-pdfs : migré vers Vercel Blob)
...
-- >>> supabase/migrations/005_accord_intervention.sql
-- =====================================================================
-- Allo Débouchage — Migration 005 — Module « Accord d'Intervention »
-- =====================================================================
...
--
-- TVA : Allo Débouchage est en franchise en base de TVA (art. 293 B du CGI).
...
-- =====================================================================
-- 5. STORAGE — désormais Vercel Blob (accords-pdfs)
-- =====================================================================
-- (bucket accords-pdfs : migré vers Vercel Blob)
...
comment on column accords_intervention.taux_tva is
  'Taux de TVA (%). 0 par défaut — Allo Débouchage en franchise en base de TVA (art. 293 B du CGI).';
...
-- >>> supabase/migrations/006_accord_copie_client.sql
-- =====================================================================
-- Allo Débouchage — Migration 006 — Accord d'Intervention : suivi de la copie client
-- =====================================================================
...
-- >>> supabase/migrations/007_terrain_step_devis.sql
...
-- >>> supabase/migrations/008_intervention_sms_envoye.sql
alter table interventions
...
-- >>> supabase/migrations/009_entreprise_kbis.sql
...
-- >>> supabase/migrations/010_releves_pre_bilan.sql
-- =====================================================================
-- Allo Débouchage Compta — Migration 010
...
-- >>> supabase/migrations/011_operations_compte_comptable.sql
...
-- >>> supabase/migrations/012_seed_technicien1.sql
...
select 'Technicien 1', 'technicien1@allo.local', true
where not exists (
  select 1 from techniciens where lower(trim(nom)) = 'technicien 1'
);

-- >>> supabase/migrations/013_comptes_techniciens.sql
...
-- >>> supabase/migrations/014_allo_debouchage_rebrand.sql
