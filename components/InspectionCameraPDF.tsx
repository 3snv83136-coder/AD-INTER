...
const Header = () => (
  <View style={s.header} fixed>
    <View>
      <Text style={s.firmName}>Allo Débouchage</Text>
...
const Footer = ({ numero }: { numero: string }) => (
  <View style={s.footer} fixed>
    <View>
      <Text style={s.footerL}>Allo Débouchage · Rapport ITV {numero}</Text>
      <Text style={s.footerL}>contact@allodebouchage.com · {TEL_PRINCIPAL_FALLBACK}</Text>
    </View>
        ...
        <View style={s.content}>
          ...
          <View style={s.metaTable} wrap={false}>
            ...
            <View style={[s.metaCell, s.metaCellLast]}>
              ...
              <Text style={s.metaValue}>{data.agence || 'Allo Débouchage'}</Text>
            </View>
          </View>
