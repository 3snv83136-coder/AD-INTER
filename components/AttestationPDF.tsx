...
const FIRM = {
  raison: ALLO_EMETTEUR.raisonSociale,
  adresse1: ALLO_EMETTEUR.adresseLignes[0] || '',
  adresse2: ALLO_EMETTEUR.adresseLignes[1] || '',
  tel: ALLO_EMETTEUR.telephone,
  email: ALLO_EMETTEUR.email,
  site: 'allodebouchage.com',
  siret: ALLO_EMETTEUR.siret || '________________',
  rcPro: process.env.NEXT_PUBLIC_ALLO_RC_PRO || '__________',
}
