...
<div class="page">
  <header class="hero">
    ...
    <div class="meta">Allo Débouchage · ${escape(TEL_PRINCIPAL_FALLBACK)}</div>
  </header>
  ...
  <div class="contact-strip">
    ...
    <p style="opacity:.8;font-size:14px">Allo Débouchage</p>
  </div>
  <footer>Aperçu — allodebouchage.com</footer>
</div>
</body></html>`
  }, [seo, ville, photos])
