...
const Header = ({ phone }: { phone?: string }) => (
  <View style={s.headerTop} fixed>
    <View style={s.brandRow}>
      <Text style={s.brandName}>Allo Débouchage</Text>
  ...
  <View style={s.footer} fixed>
    <View>
      <Text style={s.footerL}>
        Allo Débouchage · Intervention et assainissement dans le Var
      </Text>
      <Text style={s.footerL}>
        Tél. {TEL_PRINCIPAL_FALLBACK} · contact@allodebouchage.com · www.allodebouchage.com
      </Text>
    </View>
...
export function RealisationDocument({
  ...
  const ref = reference || rapport.reference || `Allo Débouchage-${dateIntervention.replace(/-/g, '')}`
        ...
        <View style={s.content}>
          ...
          <View style={s.idTable} wrap={false}>
            <View style={s.idRow}>
              ...
              <Text style={s.idValue}>Allo Débouchage</Text>
            </View>
            ...
            <View>
              ...
              <View style={s.sigTable} wrap={false}>
                <View style={[s.sigCol, s.sigColSep]}>
                  <Text style={s.sigHead}>Allo Débouchage — Technicien intervenant</Text>
      ...
      {rapport.devis && (
        <Page size="A4" style={s.page}>
          ...
          <View style={s.content}>
            ...
            <View style={s.sigTable} wrap={false}>
              <View style={[s.sigCol, s.sigColSep]}>
                <Text style={s.sigHead}>Établi par — Allo Débouchage</Text>
                <View style={s.sigBody}>
                  <Text style={s.sigLine}>Nom : {technicienNom || '—'}</Text>
                  <Text style={s.sigLine}>Date : {fmtDateFR(dateIntervention)}</Text>
                  <Text style={s.sigLine}>Signature :</Text>
