...
API integration:
- [ ] ALLO_API_URL = `https://allodebouchage.com`
- [ ] ALLO_PUBLISH_TOKEN = `ruiQvAxSn5VL075j9WfTEL7ftvykTXkEgqBvbfFQfsw`
...
### Test 6: Allo Débouchage Publishing
- [ ] Click "Publier sur le site"
- [ ] Should show "Publishing..." state
- [ ] If Allo Débouchage is accessible:
  - Should return success with new URL
  - URL should point to allodebouchage.com
- [ ] If Allo Débouchage not accessible:
...
- [ ] For Allo Débouchage publish: verify ALLO_PUBLISH_TOKEN matches Django config

### Allo Débouchage Integration Issues
- [ ] Verify ALLO_API_URL is accessible: curl https://allodebouchage.com
- [ ] Check Django backend is running
- [ ] Verify ALLO_PUBLISH_TOKEN matches exactly (check for spaces/typos)
- [ ] Check Django /api/gallery/publish/ endpoint is implemented
- [ ] Monitor server logs on Allo Débouchage backend for POST requests
...
- [ ] Can download PDF
- [ ] Can publish to Allo Débouchage (or see appropriate error if backend unavailable)
